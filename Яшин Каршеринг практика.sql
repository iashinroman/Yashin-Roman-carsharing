...
-- ============================================================
-- ЗАПРОС 1: Расчёт стоимости для всех поездок
-- ============================================================
SELECT 
    c.client_id,
